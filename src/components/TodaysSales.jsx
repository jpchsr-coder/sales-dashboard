...
import { FiTrendingUp, FiTrendingDown, FiShoppingCart, FiPackage, FiUsers, FiBarChart2 } from 'react-icons/fi'
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {salesData.map((item, index) => (
          <div key={index} className={`${item.bgColor} rounded-xl p-4`}>
            ...
            <div className="text-sm text-gray-600">{item.subtitle}</div><div className={`text-sm font-medium ${
